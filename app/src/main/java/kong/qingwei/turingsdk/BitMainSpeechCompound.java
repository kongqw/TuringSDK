 ...
 * 语音合成
 */
public class BitMainSpeechCompound {
     ...
     * @param context
     */
    public BitMainSpeechCompound(Context context) {
        // 上下文
        mContext = context;
        // 初始化合成对象
    ...
    private SynthesizerListener mTtsListener = new SynthesizerListener() {
        ...
        public void onSpeakBegin() {
            Log.i(TAG, "开始播放");
            ToastUtil.showText(mContext, "开始合成");
        }
        ...
        public void onSpeakProgress(int percent, int beginPos, int endPos) {
            ...
            ToastUtil.showText(mContext, "进度：" + percent);
        }
        ...
        public void onCompleted(SpeechError error) {
            if (error == null) {
                Log.i(TAG, "播放完成");
                ToastUtil.showText(mContext, "播放完成");
            } else if (error != null) {
